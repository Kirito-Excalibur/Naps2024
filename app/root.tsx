  ...
  return (
    <html lang="en" className="h-full">
      <head>
        ...
        <meta property="og:description" content="A dynamic administrative body dedicated to capturing and disseminating the vibrant news and media happenings across the campus"/>
